                                ...
                                <ul class="list list-inline mb-0">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-item">
                                            ...
                                            <span
                                                class="text-right float-end "><?php echo e($category->products->count()); ?></span>
                                        </li>
                            ...
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                    ...
                                    <div class="swiper-container background-img js-swiper-slider"
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                ...
                                                <a
                                                    href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>"><img
                                                        loading="lazy"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a
                                            href="<?php echo e(route('shop.product.details', ['product_slug' => $product->slug])); ?>"><?php echo e($product->name); ?></a>
                                    </h6>
...
<?php /**PATH C:\Users\itsar\Desktop\project\e-commerce\resources\views\shop.blade.php ENDPATH**/ ?>