                            ...
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    <img loading="lazy" class="w-32 h-32 object-cover rounded mb-3"
                                        ...
                                        width="128" height="128" alt="{{ $category->name ?? 'Category Image' }}" />
                                        ...
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    ...
                                                    <img loading="lazy"
                                                        src="{{ asset('storage/uploads/products/thumbnails/' . $sproduct->image) }}"
                    ...
                    <div class="col-md-6">
                        <div class="category-banner__item border-radius-10 mb-5">
                            <img loading="lazy" class="h-auto"
                                ...
                                autoplay
                                plays
                                src="https://www.adilqadri.com/cdn/shop/files/quinn_xuqkpwf9uj08284xyxnu1ivr.mp4" width="690"
                                height="665"></video> --}}
                            ...
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a
                                        ...
                                        <img loading="lazy"
                                            src="{{ asset('storage/uploads/products/thumbnails/' . $fproduct->image) }}"
