            ...
            <span class="header-user wg-user">
                <span class="image">
                    <?php if(Auth::user()->image): ?>
                        <img src="<?php echo e(asset('storage/uploads/adminImage/' . Auth::user()->image)); ?>"
                            alt="Admin Image" />
                    <?php else: ?>
    ...
    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3">
        ...
        <li>
            <a href="<?php echo e(route('admin.inbox')); ?>" class="user-item">
                ...
                <div class="number"><?php echo e(\App\Models\Order::where('status', 'Ordered')->count() ? \App\Models\Order::where('status', 'Ordered')->count() : 0); ?></div>
            </a>
        </li>
...
</div><?php /**PATH C:\Users\itsar\Desktop\project\e-commerce\resources\views\admin\admin-profile.blade.php ENDPATH**/ ?>