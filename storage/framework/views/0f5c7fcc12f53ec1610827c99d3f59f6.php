                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4><?php echo e($dashboardDatas[0]->TotalCancelled); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4><?php echo e($dashboardDatas[0]->TotalCancelledAmount); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?>
    ...
    </script><?php /**PATH C:\Users\itsar\Desktop\project\e-commerce\resources\views/admin/index.blade.php ENDPATH**/ ?>