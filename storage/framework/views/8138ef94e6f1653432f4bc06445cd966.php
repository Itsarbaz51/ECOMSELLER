...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'categories-edit']); ?>
        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1"
                    action="<?php echo e(route('admin.category.update', ['id' => $category->id])); ?>" method="post"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand name" name="name" tabindex="0"
                            value="<?php echo e($category->name); ?>" aria-required="true" required="">
                    </fieldset>
...
<?php /**PATH C:\Users\itsar\Desktop\project\e-commerce\resources\views\admin\category-edit.blade.php ENDPATH**/ ?>